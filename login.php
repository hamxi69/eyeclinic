...
<head>
  ...
  <!-- Favicons -->
  <link href="machine.png" rel="icon">
  <link href="machine.png" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Eye Clinic</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="credits">
                Designed by <a href="#">Intelysol</a>
              </div>
...
$('#loginform').submit(function(event){
  ...
  if (response.success) 
  {
    window.location.href = "appointmentlst.php";
  } else 
  {
...
{
      $('#login-error').addClass('error');
      $('#login-error').text('An error occurred while logging in. Please try again later.');
    }
  });
});
